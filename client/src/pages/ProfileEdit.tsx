...
export default function ProfileEdit() {
  ...
  const {
    ...
    values: {
      ...
      governorate: currentUser?.data.governorate as any,
      notReadyForSwap: !!currentUser?.data.notReadyForSwap,
    },
  });

  const notReadyForSwap = watch("notReadyForSwap");
  ...
  const onSubmit = async (data: ProfileFormData) => {
    try {
      ...
      if (!updatedUser.isVerified && data.mobile !== currentUser?.mobile) {
        toast.success("Phone number updated! Please verify.", { icon: "📱" });
