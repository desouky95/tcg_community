...
|------|-----|--------------|
| Primary | `#F26B3A` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#4E7BFF` | `--color-secondary` |
| On Secondary | `#0F172A` | `--color-on-secondary` |
| Accent/CTA | `#F26B3A` | `--color-accent` |
| On Accent/CTA | `#000000` | `--color-on-accent` |
| Background | `#0B0F14` | `--color-background` |
| Foreground | `#F4F0E8` | `--color-foreground` |
| Card | `#121820` | `--color-card` |
| Card Foreground | `#F4F0E8` | `--color-card-foreground` |
| Muted | `#1A232D` | `--color-muted` |
| Muted Foreground | `#9BA7B5` | `--color-muted-foreground` |
| Border | `#2B3744` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| On Destructive | `#FFFFFF` | `--color-on-destructive` |
| Ring | `#F26B3A` | `--color-ring` |

**Color Notes:** Graphite desk mat + ember action tab + cobalt discovery accent.
...
- **Google Fonts:** [Space Grotesk + DM Sans](https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=Space+Grotesk:wght@500;600;700&display=swap)
