...
- Existing React client: `client/`.
- Development fallback data: `client/src/lib/mockData.ts`.
- Existing TCG Nexus logo asset: `client/public/logo_tcg-nexus_primary_20260923.svg`.
